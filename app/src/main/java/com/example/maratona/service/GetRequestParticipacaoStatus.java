...
public class GetRequestParticipacaoStatus extends AsyncTask<String, Void, String> {
    ...
    protected String doInBackground(String... strings) {
        ...
        try {
            URL findById = new URL("http://" + ConnectionFactory.serverIP + "/participacoes/status/" + strings[0] );
