...
public class GetRequestCorredoresConcluidos extends AsyncTask<String, Void, String> {
    ...
    protected String doInBackground(String... strings) {
        ...
        try {
            URL findById = new URL("http://" + ConnectionFactory.serverIP + "/corredores/concluiram/" + strings[0] );
