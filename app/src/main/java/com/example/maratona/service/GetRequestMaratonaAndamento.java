...
public class GetRequestMaratonaAndamento extends AsyncTask<String, Void, String> {
    ...
    protected String doInBackground(String... strings) {
        ...
        try {
            URL findById = new URL("http://" + ConnectionFactory.serverIP + "/maratonas/" + strings[0] + "/em-andamento" );
