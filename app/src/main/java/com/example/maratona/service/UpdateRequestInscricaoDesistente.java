...
public class UpdateRequestInscricaoDesistente extends AsyncTask<String, Void, String> {

    @Override
    protected String doInBackground(String... strings) {
        StringBuilder apiResponse = new StringBuilder();
        try {
            URL update = new URL("http://" + ConnectionFactory.serverIP + "/inscricoes/" + strings[0] + "/desistir" );
