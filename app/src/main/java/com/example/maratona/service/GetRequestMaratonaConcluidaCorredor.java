...
public class GetRequestMaratonaConcluidaCorredor extends AsyncTask<String, Void, String> {
    ...
    protected String doInBackground(String... strings) {
        ...
        try {
            URL findById = new URL("http://" + ConnectionFactory.serverIP + "/maratonas/concluidas-por-corredor/" + strings[0] );
