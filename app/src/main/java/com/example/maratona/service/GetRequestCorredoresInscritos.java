...
public class GetRequestCorredoresInscritos extends AsyncTask<String, Void, String> {
    ...
    protected String doInBackground(String... strings) {
        ...
        try {
            URL findById = new URL("http://" + ConnectionFactory.serverIP + "/corredores/inscritos/" + strings[0] );
