...
public class GetRequestMaratonaCriador extends AsyncTask<String, Void, String> {
    ...
    protected String doInBackground(String... strings) {
        ...
        try {
            URL findById = new URL("http://" + ConnectionFactory.serverIP + "/maratonas/criador/" + strings[0] );
